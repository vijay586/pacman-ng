...
document.itxtInProg=1;var itxtIas='98affbe8317b43e9939096982c46d581';
var itxtIasCD=0;
var itxtIasED=1204054911000;
...
{
var itxturl='http://gamedev.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&ias='+itxtIas+'|'+itxtIasCD+'|'+itxtIasED+'&ipid=1966';
